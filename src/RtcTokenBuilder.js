...
class RtcTokenBuilder {
     ...
     * @param {*} appId  The App ID issued to you by Rtc service.
     * @param {*} appCertificate Certificate of the application that you registered in the Rtc Dashboard.
     ...
     * @param {*} token_expire epresented by the number of seconds elapsed since now. If, for example, you want to access the RTC Service within 10 minutes after the token is generated, set token_expire as 600(seconds)
